          ...
          >
            {cards.map((item, i) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end bg-linear-to-b from-black/0 from-50% to-black/80 px-5 py-6 text-white">
